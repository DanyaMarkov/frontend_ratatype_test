        ...
        <div>
            <div className={css.body}>
                <div className={css.body__text}>
                    <div className={css.behindText}>
                        {statsStore.selectedText}
                    </div>

                    <div className={css.mainText}>
                        <textarea
                            value={statsStore.currentInput}
                            onChange={(e) => statsStore.handleChange(e)}
                        >
                ...
                <div className={css.body__info}>
                    <div className={css.languages}>
                        <div
                            ...
                            className={
                                statsStore.currLanguage === "russian"
                                    ? css.languages__el_active
                                    : css.languages__el
                            }
                        >
                        ...
                        <div
                            ...
                            className={
                                statsStore.currLanguage === "english"
                                    ? css.languages__el_active
                                    : css.languages__el
                            }
                        >
